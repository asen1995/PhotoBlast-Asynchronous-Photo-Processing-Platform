...
class PhotoUploadIntegrationTest {
    ...
    class HealthEndpoint {
        ...
        @Test
        @DisplayName("should return OK without idempotency key")
        void shouldReturnOkWithoutIdempotencyKey() throws Exception {
    ...
    @Nested
    @DisplayName("Upload Endpoint with Idempotency")
    class UploadWithIdempotency {

        @Test
        @DisplayName("should reject upload without idempotency key")
        void shouldRejectUploadWithoutIdempotencyKey() throws Exception {
        ...
        @Test
        @DisplayName("should upload photo successfully with idempotency key")
        ...
        @Test
        @DisplayName("should upload photo with all processing tasks")
        void shouldUploadPhotoWithAllTasks() throws Exception {
            MockMultipartFile file = createTestImageFile();
            String idempotencyKey = UUID.randomUUID().toString();
        ...
        @Test
        @DisplayName("should return error for non-image file")
        void shouldReturnErrorForNonImageFile() throws Exception {
    ...
    class IdempotencyBehavior {
        ...
        void shouldReturnSameResponseForDuplicateKey() throws Exception {
            MockMultipartFile file = createTestImageFile();
            String idempotencyKey = UUID.randomUUID().toString();
        ...
        @Test
        @DisplayName("should use different responses for different idempotency keys")
        void shouldUseDifferentResponsesForDifferentKeys() throws Exception {
            ...
            // Both should succeed but have different photo IDs
